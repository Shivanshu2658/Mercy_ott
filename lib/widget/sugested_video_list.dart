          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return VideoThumbnailCard(
                ...
                focusNode: index < controller.videoFocusNodes.length
                    ? controller.videoFocusNodes[index]
                    : FocusNode(),
    ...
    return Padding(
      ...
      child: Focus(
        ...
        onFocusChange: (hasFocus) async {
          if (hasFocus) {
            final controller = Get.find<SuggestedVideoController>();
            final index = controller.videoFocusNodes.indexOf(focusNode);
            controller.currentlyPlayingIndex.value = index;
            await controller.scrollToIndexThrottled(index);
          }
        },
